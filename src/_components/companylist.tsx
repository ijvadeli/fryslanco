...
const companiesFeatured = [
  {
    name: "Councile Studio",
    category: "Design - Development - Animation",
    rating: "6.2K",
  },
  {
    name: "Marine Engineering",
    category: "Shipbuilding - Maintenance",
    rating: "6.2K",
  },
  {
    name: "Marine Engineering",
...
const topCompanies = [
  { name: "Formance", category: "Inspections", rating: "6.9K" },
  {
    ...
    category: "Bridge Design - Inspections",
    rating: "9.2K",
  },
  {
    name: "Civil Engineering",
...
const CompanyList = () => {
  return (
    <div className="mx-5 md:mx-0">
      ...
      <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 my-6 mb-8">
        Uitgelichte Bedrijven
      </h2>{" "}
      {companiesFeatured.map((company, index) => (
        <div
          key={index}
          className="flex items-center justify-between p-2 mb-5 rounded-[10px] border shadow-sm"
        >
      ...
      {/* Top bedrijven blok */}
      <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 my-6 mb-8">
        Topbedrijven deze maand
      </h2>
      {topCompanies.map((company, index) => (
        <div
          key={index}
          className="flex items-center justify-between p-2 mb-5 rounded-2xl border shadow-sm"
        >
          <div className="flex items-center">
            <div className="p-3 mr-4">
              <PlaceholderLogo />
